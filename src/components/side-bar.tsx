...
export function SidebarDemo({ children }: { children: ReactNode }) {
  ...
  return (
    <div
      className={cn(
        "rounded-md flex flex-col md:flex-row bg-gray-100 dark:bg-background w-screen flex-1 mx-auto border border-neutral-200 dark:border-neutral-700 overflow-hidden",
...
export const Logo = () => {
  return (
    <Link
      href="#"
      className="font-normal flex space-x-2 items-center text-sm text-black px-3 py-2 relative z-20"
    >
